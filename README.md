...
Client side routing is when part of data is stored within the javascript rather than the page having to request that data from a server. Allows for faster load times after initial html request.
